...
{
    public class CircleFigure : IFigure2points
    {
        RectangleF rect;
        ...
        public CircleFigure(PointF rectLUPoint, PointF rectOppositePoint)
        {
        ...
        public Bitmap Move(Bitmap curBitmap, Graphics graphics, Pen pen, PointF delta)
        {
            ...
            rect = new RectangleF(rectLUPoint.X, rectLUPoint.Y, rectOppositePoint.X - rectLUPoint.X, rectOppositePoint.X - rectLUPoint.X);
            graphics.DrawEllipse(pen, rect);
            return curBitmap;
        }
